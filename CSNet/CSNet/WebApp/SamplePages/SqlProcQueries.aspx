                ...
                <asp:GridView ID="CategoryProductList" runat="server" AutoGenerateColumns="False" AllowPaging="True" CellPadding="5" CellSpacing="5" GridLines="Horizontal" OnPageIndexChanging="CategoryProductList_PageIndexChanging" PageSize="3" OnSelectedIndexChanged="CategoryProductList_SelectedIndexChanged">
                    <Columns>
                        <asp:TemplateField Visible="False" >
                            <ItemTemplate>
                                <asp:Label ID="ProductID" runat="server" Text='<%# Eval("ProductName") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Product">
                            <ItemTemplate>
                                <asp:Label ID="ProductName" runat="server" Text='<%# string.Format("{0:0.00}", Eval("ProductName")) %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" />
                        </asp:TemplateField>
                    ...
                    <PagerSettings FirstPageText="Start" LastPageText="End" Mode="NumericFirstLast" NextPageText="Next" PageButtonCount="3" PreviousPageText="Previous" />
                </asp:GridView>
            </td>
