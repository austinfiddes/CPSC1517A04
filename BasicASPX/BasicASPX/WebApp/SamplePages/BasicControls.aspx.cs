    ...
    public partial class BasicControls : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //one will use the index zero to position the prompt 
        ...
        protected void SubMitButton_Click(object sender, EventArgs e)
        {
            ...
            //.SelectedValue : the accociated data value of the item in the list 
            //.SelectedItem  : the associated data display text of the item in the list 
            //for boolean controls (RadioButtons, CheckBox) use .Checked 
